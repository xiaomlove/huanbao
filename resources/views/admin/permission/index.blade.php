...
@section('content_header')
    ...
    <form class="form-inline">
        ...
        <!--
        <a class="btn btn-info pull-right" href="{{ route('admin.permission.create') }}">新建</a>
        -->
    </form>
@stop
        ...
        @foreach($list as $value)
            <tr>
                ...
                <td>
                    ...
                    <form method="post" style="display: inline-block;" action="{{ route('admin.permission.destroy', $value->id) }}" onsubmit="return window.confirm('确定删除？')">
                        {{ csrf_field() }}
                        {{ method_field('DELETE') }}
