            ...
            <div class="card-block">
              <form class="form-horizontal" method="post" action="{{ route('role.store') }}" enctype="multipart/form-data">
                ...
                <div class="form-group row{{$errors->has('display_name') ? ' has-danger' : ''}}">
                  ...
                  <div class="col-sm-10">
                    <input id="" type="text" name="display_name" value="{{ old('display_name') }}" placeholder="display_name" class="form-control form-control-success">
